...
$(document).ready(function () {
  ...
  $('#save').on('click', function () {
    swal({
      ...
      text: 'El caso se ha cargado exitosamente',
      buttonsStyling: false,
  ...
  $('#confirm').on('click', function () {
    swal({
      title: '¿Estas seguro?',
      text: "Se guardaran los datos en la tabla",
      type: 'warning',
      showCancelButton: true,
      ...
      swal('¡Guardado!', 'Un nuevo caso ha sido agregado.', 'success');
      if (result) {
        
        // Si el usuario confirma, redirige a otra página
       // window.location.href = '../../../html/layout3/casosPendientes.html'; // Cambia la URL por la que necesitas
      }
      
    }, function (dismiss) {
      // dismiss can be 'overlay', 'cancel', 'close', 'esc', 'timer'
      if (dismiss === 'cancel') {
        swal('Cancelado', 'El caso no hasido guardado', 'error');
      }
    });
  });
});